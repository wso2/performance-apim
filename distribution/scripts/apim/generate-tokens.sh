...
do
    ...
    echo "INSERT INTO IDN_OAUTH2_ACCESS_TOKEN (TOKEN_ID, ACCESS_TOKEN, REFRESH_TOKEN, CONSUMER_KEY_ID, AUTHZ_USER, \
        ...
        REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_SCOPE_HASH, TOKEN_STATE, USER_TYPE, GRANT_TYPE, SUBJECT_IDENTIFIER,ACCESS_TOKEN_HASH,REFRESH_TOKEN_HASH) \
        SELECT '$TOKEN_ID','$ACCESS_TOKEN_KEY','$REFRESH_TOKEN_KEY',ID,'admin',-1234,'PRIMARY', \
        '$NOW','$NOW',99999999000,99999999000,'$TOKEN_SCOPE_HASH', \
        'ACTIVE','APPLICATION_USER','password','admin@carbon.super','$ACCESS_TOKEN_HASH_JSON','$REFRESH_TOKEN_HASH_JSON' \
