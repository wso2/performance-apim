...
| Concurrent Users | The number of users accessing the application at the same time. | 2 |
| GraphQL Query | The GraphQL query number. | 1 |
| Back-end Delay (ms) | The delay added by the back-end service. | 0 |

The duration of each test is **10 seconds**. The warm-up period is **1 seconds**.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
|  StarwarsGraphqlApi | 2G | 2 | 1 | 0 | 100 | 140.59 | 2.09 | 3.64 | 10 | 96.27 |  |
